				...
				<div className="banner-left-box">
					<div className="banner-content">
						<span className="sub-title wow fadeInDown" data-wow-delay=".2s">
							<i className="tji-excellence"></i> Your Gateway to East Africa
						</span>
						<h1 className="banner-title title-anim">
							Opening East African Markets to the <span>World.</span>
						</h1>
						<div className="banner-desc-area wow fadeInUp" data-wow-delay=".7s">
							...
							<div className="banner-desc">
								...
								your partner across Kenya, Uganda, Tanzania, and Rwanda.
							</div>
						</div>
					</div>
					...
					<div className="box-area">
						<div className="customers-box">
							...
							<h6 className="customers-text wow fadeInUp" data-wow-delay=".5s">
								Successful market entries across East Africa.
							</h6>
						</div>
					</div>
				</div>
